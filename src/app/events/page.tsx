...
/*
  ...
  Remaining images/videos keep their original order.
*/
function sortMediaFiles(files: string[]) {
  return [...files].sort((a, b) => {
    const aVideo = isVideo(a);
    const bVideo = isVideo(b);
...
function groupEvents(events: EventItem[]): EventGroup[] {
  ...
  /*
    Video first for every folder.
  */
  return Object.values(map).map((group) => ({
    ...group,
    files: sortMediaFiles(group.files),
  }));
}
